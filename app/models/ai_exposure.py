...
class ExposedActivity(Base):
    ...
    assessment: Mapped["AiExposureAssessment"] = relationship(back_populates="exposed_activities")
...
class SkillRelevance(Base):
    ...
    assessment: Mapped["AiExposureAssessment"] = relationship(back_populates="skill_relevances")
